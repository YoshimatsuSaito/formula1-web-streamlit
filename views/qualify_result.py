...
def _read_data() -> pd.DataFrame:
    ...
    df_qualifying = pd.read_csv(
        ...
        usecols=["driverId", "position", "raceId", "q1", "q2", "q3"],
        dtype={"q1": str, "q2": str, "q3": str},
    )
...
def qualify_result() -> None:
    ...
    selected_season = st.selectbox(
        "Select season", list_season, key="selected_season_qualify_result"
    )
    ...
    df_qualify.insert(
        ...
        (
            (
                (
                    df_qualify["qualifying time(sec)"]
